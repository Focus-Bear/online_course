...
const TrendingCourse = () => {
  return (
    <div className='w-1/4 h-5/6 orounded flex flex-col px-3 py-2 gap-2 bg-gray-100 rounded overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-100 '>
